...
Currently, Mart is in its development phase. The table below reflects the support status of Mart versions:
...
The Mart team takes security bugs seriously. We appreciate your efforts to responsibly disclose your findings, and will make every effort to acknowledge your contributions.
...
- The issue has been disclosed publicly by the Mart team.

This policy ensures that Mart users have time to deploy fixes before the vulnerability is publicly disclosed.
